...
ts_plot <- autoplot(transmission_ts[,2])
ACF <- Acf(transmission_ts[,2], lag.max = 40, plot=FALSE)
PACF <- Pacf(transmission_ts[,2], lag.max = 40, plot=FALSE)
...
#Decompose
transmission_ts_decomp <- decompose(transmission_ts[,2], "multiplicative")
...
SMKtest <- SeasonalMannKendall(transmission_ts[,2])
print(summary(SMKtest))

ADFTest <- adf.test(transmission_ts[,2], alternative = "stationary")
print(ADFTest)
...
transmission_ts_training <- ts(transmission_training, start=c(2015,4),end = c(2023,3),frequency = 12)
transmission_ts_testing <- ts(transmission_testing, start=c(2023, 4),end = c(2024,1),frequency = 12)

#Fitting the model
print(auto.arima(transmission_ts_training[,2]))
transmission_training_ARIMA021101 <- Arima(transmission_ts_training[,2], 
...
Forecast1 <- forecast(transmission_training_ARIMA021101, h=12)

#Plotting forecast of testing data
